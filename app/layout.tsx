...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'İlan Pusulası', description: 'Bir ilana ne kadar hazırsın?', images: ['/og.png'] },
  twitter: { card: 'summary_large_image', title: 'İlan Pusulası', description: 'Bir ilana ne kadar hazırsın?', images: ['/og.png'] },
};
